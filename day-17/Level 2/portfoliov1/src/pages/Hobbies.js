export const Hobbies=()=>{
    return (
        ...
        <ul class="list-disc">
            <li><h2 align='left' class="font-bold leading-7 sm:truncate sm:text-2xl sm:tracking-tight">Watching Formula 1</h2></li>
            ...
            <li><h2 align='left' class="font-bold leading-7 sm:truncate sm:text-2xl sm:tracking-tight">Playing around with Linux</h2></li>    
            <img class="hobbies" src="https://e7.pngegg.com/pngimages/250/100/png-clipart-linux-linux.png"></img>
        </ul>
        </div>
        // <br/>
        // </div>
